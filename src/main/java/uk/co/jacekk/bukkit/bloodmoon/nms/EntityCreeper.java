...
import net.minecraft.server.v1_5_R1.PathfinderGoalAvoidPlayer;
...
import net.minecraft.server.v1_5_R1.PathfinderGoalSwell;
...
public class EntityCreeper extends net.minecraft.server.v1_5_R1.EntityCreeper {
